  ...
  <div class="working__top" data-rellax-speed="-8" data-rellax-percentage="0.5">
    ...
    <div class="container">
      <div class="working__inner">
        ...
        <div class="working__content" date-rellax-speed="2" data-rellax-percentage="0.5">
          ...
          <div class="working__content-item" data-animate="fade">
            <p class="working__content-title">家電付きマンション完備</p>
            <div class="working__content-text">
              <p>築浅マンション！家具・家電が完備してある<br>
                綺麗な室内で快適に♡即日入居OK！</p>
            </div>
          </div>
          <div class="working__content-item" data-animate="fade">
      ...
      <div class="working__bottom rellax" data-rellax-speed="3"
        ...
        <div class="working__bottom-item">
          <div class="working__bottom-img">
            <img src="<?php echo $path; ?>assets/img/working_1.png" alt="ボトム">
          </div>
        ...
        <div class="working__bottom-item">
          <div class="working__bottom-img">
            <img src="<?php echo $path; ?>assets/img/working_2.png" alt="ボトム">
          </div>
          <div class="working__bottom-text">
            築浅マンションでWiFi完備！<br>
            家具・家電も揃ってます。<br>
